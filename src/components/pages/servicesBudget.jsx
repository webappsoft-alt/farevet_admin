...
const ServicesBudget = () => {
    ...
    const fieldMappings = [
        { key: 'current_budget', title: 'What is your current monthly pet budget ($)?', prefix: '$' },
        { key: 'budget_concerns', title: 'What are you most concerned about?' },
        { key: 'upcoming_expenses', title: 'Any upcoming expenses we should factor in?' },
        { key: 'target_budget', title: 'What\'s your target monthly spend on pet care ($)?', prefix: '$' },
                        ...
                        <div style={{
                            ...
                            <div className="row">
                                {fieldMappings?.map((field) => {
                                    ...
                                    if (field.key === 'budget_concerns' || field.key === 'upcoming_expenses') {
                                        value = parseJsonField(value);
                                    }

                                    // Handle budget values with prefix
                                    if ((field.key === 'current_budget' || field.key === 'target_budget') && value) {
