...
const UpdatePetInsurance = () => {
    ...
    useEffect(() => {
        if (insuranceData) {
            setCoverExisting(insuranceData?.cover_existing || "no");
    ...
    const handleSubmit = async (values) => {
        ...
        body.append("logo", loadselectedFile ? loadselectedFile : insuranceData?.logo);
    ...
    return (
        <main className='container m-auto min-h-screen py-4'>
            <div className="flex items-center gap-3 mb-4">
                ...
                <span className="inter_semibold text-xl md:text-2xl text_dark">Update Pet Insurance</span>
            </div>
                            ...
                            <div>
                                <label htmlFor="fileInput" className="cursor-pointer">
                                    {selectedFile ? (
                                        ...
                                        <img style={{ height: '100px', width: '120px' }} src={insuranceData?.url + insuranceData.logo} alt="Current Logo" className="rounded-lg object-cover" />
                                    ) : (
                ...
                <div className="flex justify-end w-full my-3">
                    {!isProcessing ? (
                        <button type='submit' className="flex justify-center bg_primary py-[12px] px-[1rem] rounded-lg items-center button_shadow">
                            <span className="inter_semibold text-sm text_white">Update Pet Insurance</span>
                        </button>
                    ) : (
